 ...
 * il a un paramettre $combinaisonNumber representant la mémoire de récursivité
 */
function genererchiffres(array $combinaisonNumber = [])
{
    ...
    if($array_count < 6){
        ...
        return genererchiffres($combinaisonNumber);
    }
